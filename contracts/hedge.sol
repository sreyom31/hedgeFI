...
contract SplitInsurance {
    ...
    address public  c = 0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8; // Maker DAI token
    address public  x = 0xDA0bab807633f07f013f94DD0E6A4F96F8742B53; // Aave v2 lending pool
    address public  y = 0x358AA13c52544ECCEF6B0ADD0f801012ADAD5eE3; // Compound
    address public cx = 0x80922Db6752eCe1C2DeFA54Beb8FB984E649308B; // Aave v2 interest bearing DAI (aDAI)
    address public cy = 0x568864A892a1B25127018Be020d2AF585Dff6c96; // Compound interest bearing DAI (cDAI)
    ...
    */
    ...
    function invest() public {
        ...
        // Protocol X: Aave Protocol Y: Compound
        cToken.approve(x, balance_c);
        investing(x).deposit(balance_c / 2);
        investing(y).deposit(balance_c / 2);
    ...
    /// @dev    Should be incentivized for the first successful call
    function divest(uint _depositIndex) public {
      ...
      //IAaveLendingpool(x).withdraw(c, balance_cx, me);
        investing(x).withdraw(_depositIndex);
        ...
        // Protocol Y: Compound
        investing(y).withdraw(_depositIndex);
